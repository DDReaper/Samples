...
namespace Platformer2DGameLibrary
{
    ...
    public class Platformer2DGame
    {
        ...
        public Platformer2DGame(Game game)
        {
            this.game = game;
        }
        ...
        public void LoadContent(ContentManager Content)
        {
            ...
            float horScaling = game.GraphicsDevice.PresentationParameters.BackBufferWidth / baseScreenSize.X;
            float verScaling = game.GraphicsDevice.PresentationParameters.BackBufferHeight / baseScreenSize.Y;
        ...
        public void Update(GameTime gameTime, DisplayOrientation currentOrientation)
        {
